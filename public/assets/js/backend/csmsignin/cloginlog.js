define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/cloginlog/index' + location.search,
                    add_url: 'csmsignin/cloginlog/add',
                    edit_url: 'csmsignin/cloginlog/edit',
                    del_url: 'csmsignin/cloginlog/del',
                    multi_url: 'csmsignin/cloginlog/multi',
                    import_url: 'csmsignin/cloginlog/import',
                    table: 'csmsignin_cloginlog',
                }
            });
