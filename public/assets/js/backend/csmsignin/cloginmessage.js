define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/cloginmessage/index' + location.search,
                    add_url: 'csmsignin/cloginmessage/add',
                    edit_url: 'csmsignin/cloginmessage/edit',
                    del_url: 'csmsignin/cloginmessage/del',
                    multi_url: 'csmsignin/cloginmessage/multi',
                    import_url: 'csmsignin/cloginmessage/import',
                    table: 'csmsignin_cloginmessage',
                }
            });
