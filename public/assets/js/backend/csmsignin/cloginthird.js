define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/cloginthird/index' + location.search,
                    add_url: 'csmsignin/cloginthird/add',
                    edit_url: 'csmsignin/cloginthird/edit',
                    del_url: 'csmsignin/cloginthird/del',
                    multi_url: 'csmsignin/cloginthird/multi',
                    import_url: 'csmsignin/cloginthird/import',
                    table: 'csmsignin_cloginthird',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'fauser_nickname', title: __('User_id')},
