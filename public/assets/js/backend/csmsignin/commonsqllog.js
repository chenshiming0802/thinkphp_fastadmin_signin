define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/commonsqllog/index' + location.search,
                    add_url: 'csmsignin/commonsqllog/add',
                    edit_url: 'csmsignin/commonsqllog/edit',
                    del_url: 'csmsignin/commonsqllog/del',
                    multi_url: 'csmsignin/commonsqllog/multi',
                    import_url: 'csmsignin/commonsqllog/import',
                    table: 'csmsignin_commonsqllog',
                }
            });
