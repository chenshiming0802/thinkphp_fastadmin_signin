define(['jquery', 'bootstrap', 'backend', 'table', 'form','csmsignin_xcore'], function ($, undefined, Backend, Table, Form,xcore) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/dmoapply/index' + location.search,
                    add_url: 'csmsignin/dmoapply/add',
                    edit_url: 'csmsignin/dmoapply/edit',
                    del_url: 'csmsignin/dmoapply/del',
                    multi_url: 'csmsignin/dmoapply/multi',
                    import_url: 'csmsignin/dmoapply/import',
                    table: 'csmsignin_dmoapply',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'csmsignin_dmocategory_name', title: __('Csmsignin_dmocategory_id')},
                        {field: 'csmsignin_dmocategorys_name', title: __('Csmsignin_dmocategory_ids'), operate: 'LIKE'},
        ...
        edit: function () {
            ...
            // csmsignin: 根据不同的状态,显示不同的字段 , -2=申请撤销,-1=审核退回,0=待审核,1=审核通过
            ...
            $(".btnok").click(function () {
                Layer.confirm('请确定是否执行审核通过操作', function (index) {
                    Fast.api.ajax({
                        url: Fast.api.fixurl("csmsignin/dmoapply/submitAudit"),
                        type: "post",
            ...
            $(".btnno").click(function () {
                Layer.open({
                    ...
                    yes: function (index, layero) {
                        Fast.api.ajax({
                            url: Fast.api.fixurl("csmsignin/dmoapply/submitReject"),
                            type: "post",
                            data: {
                                id: $("#c-id").val(),
