define(['jquery', 'bootstrap', 'backend', 'table', 'form','csmsignin_xcore'], function ($, undefined, Backend, Table, Form,xcore) {
    ...
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmsignin/dmo/index' + Controller._queryString,
                    add_url: 'csmsignin/dmo/add' + Controller._queryString,
                    edit_url: 'csmsignin/dmo/edit',
                    del_url: 'csmsignin/dmo/del',
                    multi_url: 'csmsignin/dmo/multi',
                    import_url: 'csmsignin/dmo/import',
                    table: 'csmsignin_dmo',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'csmsignin_dmoapply_id', title: __('Csmsignin_dmoapply_id')},
                        {field: 'name', title: __('Name'), operate: 'LIKE'},
                        {field: 'csmsignin_dmocategory_id', title: __('Csmsignin_dmocategory_id')},
                        {field: 'csmsignin_dmocategory_ids', title: __('Csmsignin_dmocategory_ids'), operate: 'LIKE'},
