...
use addons\csmsignin\library\xcore\xcore\utils\XcDateUtils;
use addons\csmsignin\library\xcore\xcore\utils\XcDebugUtils;
use addons\csmsignin\library\xcore\xcore\utils\XcRequestUtils;
use addons\csmsignin\library\xapp\csmsignin\XpAddon;
use addons\csmsignin\library\xcore\xcore\utils\XcDashboardUtils;
...
class XpDmoDashboard extends Backend
{
    public function tongji1()
    {
        ...
        if (true) {
            $dao = new \app\admin\model\csmsignin\Cloginlog();
    ...
    public function page1_list1()
    {
        ...
        $list = $dao->alias("log")
            ...
            ->join("csmsignin_dmo dmo", "log.object_id=dmo.id")
    ...
    public function page1_list2()
    {
        ...
        $list = $dao->alias("user")
            ->join("fa_csmsignin_dmo dmo", "dmo.user_id=user.id")
