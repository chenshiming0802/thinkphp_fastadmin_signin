	...
	<view class="xc-wrap">
		<view class="xc-block">
			<uv-form labelPosition="left" :model="control.form" :rules="control.rules" ref="form" labelWidth="80px">
				...
				<uv-form-item label="分类" prop="csmsignin_dmocategory_id" required borderBottom>
					<xc-uv-select v-model="control.form.csmsignin_dmocategory_id" :list="sr.dmocategorys"
						labelField="name" valueField="id"></xc-uv-select>
				</uv-form-item>
				<uv-form-item label="分类(多选)" prop="csmsignin_dmocategory_ids" required borderBottom>
					<xc-uv-select v-model="control.form.csmsignin_dmocategory_ids" :list="sr.dmocategorys"
			...
			return {
				...
				control: {
					form: {
						id: null,
						name: null,
						csmsignin_dmocategory_id: null,
						csmsignin_dmocategory_ids: null,
						type: null,
						types: null,
						content: null,
						bannerimage: null,
					...
					rules: {
						...
						csmsignin_dmocategory_id: {
							required: true,
							message: '请选择',
						},
						csmsignin_dmocategory_ids: {
							required: true,
							message: '请选择',
						},
						type: {
