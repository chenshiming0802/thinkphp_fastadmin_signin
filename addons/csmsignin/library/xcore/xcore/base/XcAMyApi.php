...
use addons\csmsignin\library\xcore\xcore\utils\XcAssertUtils;
use addons\csmsignin\library\xcore\xcore\utils\XcDaoUtils;
use addons\csmsignin\library\xcore\xcore\utils\XcRequestUtils;
use addons\csmsignin\library\xcore\xcore\utils\XcResponseUtils;
...
class XpmyDemo extends XcMyApi
{
    ...
    {
        $this->model = new \app\admin\model\csmsignin\Myfriend();
    }
}
 */
