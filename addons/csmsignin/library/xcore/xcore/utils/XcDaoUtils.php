...
class XcDaoUtils
{
    ...
    public static function getRowById($dao, $id, $hasNormalField = false, $isAssert = true, $fields = "*")
    {
        ...
        if ($isAssert === true) {
            XcAssertUtils::assertNotNull($row, "记录#{$id}不存在或已经被删除");
        }
    ...
    public static function getCountBySql($dao, $whereFieldValues, $fieldString = null, $orders = null, $hasNormalField = true)
    {
        $list = null;
        $dao = $dao->alias('t');
        if ($fieldString != null) {
